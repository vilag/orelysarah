...
<b id="idgrupo" style="display: none;"><?php echo $_GET['id']; ?></b>
    <div style="width: 100%; height: 180vh; padding: 20px; text-align: center; background-image: url(img/fondo_regalo2.png); background-repeat: no-repeat; background-size: cover;">
        ...
        <div style="width: 100%; margin: 10px; color: #fff;">
            <p>Damos muchas gracias a Dios por estar viviendo esta experiencia tan hermosa, desde el momento en que decidimos comprometernos solo hemos tenido algo en mente, dedicar nuestras vidas al servicios del Señor.</p>
            ...
            <p>Si estas aquí con el deseo de obsequiarnos algo para el dia de nuestra boda, antes que nada damos gracias a Dios por ti vida porque eres parte de la respuesta de Dios a nuestras oraciones.</p>
            <p>Si Dios permite, unos dias despues de la boda nos mudaremos a Dallas Texas en los Estados Unidos para que con la dirección de Dios podamos seguir preparandonos para el servicio del Señor, es por ello que si tu deseo era darnos un regalo, te quisieramos pedir algo especial, ya que no podremos llevarnos muchas cosas nos encantaria que pudieras depositarnos la cantidad equivalente al regalo que el Señor haya puesto en tu corazon. Este recurso será utilizado para nuestro sustento asi como para nuestros estudios.</p>
            <p>Si no fuera posible que nos pudieras ayudar de esta forma, con toda tranqulidad te decimos que te entendemos y te pedimos que no te preocupes, si tu deseo es el apoyarnos de esta forma a continuacion te dejamos nuestros datos bancarios.</p>
